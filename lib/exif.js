...
async function newSticker(path, url, packname, author, categories = ['']) {
  ...
  return await new WSF.Sticker(path ? path : url, stickerMetadata).build()
}
...
async function writeExifImg(media, metadata) {
  ...
  if (metadata.packname || metadata.author) {
    ...
    const json = {
      "sticker-pack-id": `https://github.com/DrkBotBase/MyBot_V2`,
